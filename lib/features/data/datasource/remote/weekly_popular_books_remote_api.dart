...
class WeeklyPopularBooksRemoteDataSourceImpl extends WeeklyPopularBooksRemoteDataSource {
  ...
  Future<List<WeeklyPopularBooksEntity>> getWeeklyPopularBooks() async {
    ...
    if (response.statusCode == 200) {
      ...
      return responseBody.map((e) => WeeklyPopularBooksModel.fromMap(e)).toList();
    } else {
